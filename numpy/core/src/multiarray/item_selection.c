...
PyArray_KeySort(PyArrayObject *self, PyObject *sort_keys, int axis)
{
    ...
    npy_intp astride, rstride, *iptr, selstride;
    int nd;
    int needcopy = 0;
    int elsize;
    int maxelsize;
    ...
    */
    ...
    if (needcopy) {
        ...
        while (size--) {
            ...
            PyArrayObject *sorted_slice = (PyArrayObject*)array_subscript_asarray(slice, indarray);
        ...
        while (size--) {
            ...
            npy_intp dims[1] = {N};
            PyObject *indarray = PyArray_SimpleNewFromData(1, dims, NPY_INTP, rit->dataptr);
            ...
            PyArrayObject *sorted_slice = (PyArrayObject*) array_subscript_asarray((PyArrayObject*)slice, indarray);
            if (sorted_slice == NULL) {
                Py_DECREF(indarray);
                Py_DECREF(slice);
                goto fail;
